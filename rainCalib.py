...
try:
    print owproxy.ping()
    print owproxy.dir()
##    prevCount = owproxy.read('/uncached/1D.82CA0D000000/counters.A')
##    prevTime = time.time()
...
##        count = owproxy.read('/uncached/1D.82CA0D000000/counters.A')

        time.sleep(1)

##        currentTime = time.time()
        count = owproxy.read('/uncached/1D.82CA0D000000/counters.B')
